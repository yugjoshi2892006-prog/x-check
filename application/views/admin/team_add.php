    ...
    <div class="page-content">
        <div class="container-fluid py-4 px-4">
            ...
            <style>
                ...
                .required-field.is-invalid~.field-error {
                    display: block;
                }
                ...
                .type-check-label input:checked~.check-text {
                    color: var(--teal);
                    font-weight: 500;
                }
                ...
                .status-radio-label:has(input[value="Active"]:checked) {
                    border-color: #1a7a4a;
                    background: #e6f9f0;
                    color: #1a7a4a;
                }

                .status-radio-label:has(input[value="Active"]:checked) .dot {
                    background: #1a7a4a;
                }

                .status-radio-label:has(input[value="Inactive"]:checked) {
                    border-color: #a32d2d;
                    background: #fde8e8;
                    color: #a32d2d;
                }

                .status-radio-label:has(input[value="Inactive"]:checked) .dot {
                    background: #a32d2d;
                }
                ...
                <form method="post" action="<?= base_url('index.php/team/insert') ?>" autocomplete="off" id="teamForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="mobile" class="form-control required-field"
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <div style="position:relative;">
                                <input type="password" name="password" id="passwordField"
                                    class="form-control required-field" placeholder="Enter password"
                                    autocomplete="new-password" style="padding-right:42px;">
                                <span onclick="togglePass()"
                                    style="position:absolute;right:12px;top:50%;transform:translateY(-50%);cursor:pointer;color:#aaa;font-size:16px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="country" class="form-control required-field"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="state" class="form-control required-field"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="city" class="form-control required-field" placeholder="Enter city">
                    ...
                    <div class="d-flex gap-3 pt-2"
                        style="border-top:1px solid #f0f2f5; padding-top:1.25rem !important;">
