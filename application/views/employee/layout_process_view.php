        ...
        <div class="xc-card">
            ...
            <div class="xc-card-body">
                ...
                <div class="row">
                    ...
                    <?php if (!empty($report->client_remark) || !empty($report->pmc_remark)) { ?>
                        <div class="col-md-12 mb-3">
                            <label class="xc-label">Client / PMC Remark</label>
                            <div class="xc-box">
                                <?= html_escape(trim($report->client_remark . "\n" . $report->pmc_remark)); ?>
                            </div>
                        </div>
                    <?php } ?>
                </div>
                ...
                <?php if ($this->session->userdata('role') === 'customer' || (!empty($layout_role) && $layout_role->role === 'PMC')) { ?>
                    <?php if (in_array($report->status, ['Submitted', 'Revised'])) { ?>
                        <hr>
                ...
                <?php if (!empty($layout_role) && $layout_role->role === 'Architect' && $report->status === 'Remarked') { ?>
                    <hr>
